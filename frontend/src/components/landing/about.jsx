    ...
    <section id="about" className="flex flex-col p-6 bg-white text-slate-900 text-center h-screen items-center justify-center">
      ...
      <div className="flex flex-col space-y-2 items-center">
        <p className="text-lg mb-6 md:w-4/5 text-center">
          Esta aplicación nace del deseo de facilitar la vida de los emprendedores colombianos que gestionan sus negocios sin grandes recursos. Aquí, la inteligencia artificial se pone a tu servicio para crear plantillas en Excel que responden a las necesidades específicas de tu inventario.
          <br></br>
